 ...
 */
module.exports = function gallery(data, caption = '') {
  ...
  const galleryContent = markdown.renderInline(data, { 'inGallery': true, 'evenItems': evenItems });
  return `<figure>${galleryContent}<figcaption>${markdown.renderInline(caption)}</figcaption></figure>`;
}
